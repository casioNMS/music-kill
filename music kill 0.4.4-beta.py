...
class MusicKill(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Music Kill 0.4.3-beta")
        ...
        self.lbl_cover.setStyleSheet("background-color: #111; boder: 1px solid #00ff99;")   
        ...
        btn_back10 = QPushButton("⏮ 10S")
        btn_back10.clicked.connect(self.back_10)
        controls.addWidget(btn_back10)

        btn_forward10 = QPushButton("⏭ 10S")
        btn_forward10.clicked.connect(self.forward_10)
        controls.addWidget(btn_forward10)
    ...
    def load_cover(self, path): #carregar capa, lembrar de estudar tal função
        try:
            audio = MP3(path)
            ...
            self.lbl_cover.setText("Erro ao carregar capa")
